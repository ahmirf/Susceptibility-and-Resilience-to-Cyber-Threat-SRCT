...
class MyTaskbar(wx.PyControl):
    ...
    def initiate(self):
        ...
        tipballoon1 = BT.BalloonTip(self.getScaledBitmap(self.infoImg, 18, 18), toptitle=toptitle,
...
#         tipballoon1.SetEndDelay(3000)
    ...
    def showJavaUpdate(self):
        self.StartJavaUpdate()
        self.tip.onMySanket()
        print self.tip.OnDestroy(self, event)
