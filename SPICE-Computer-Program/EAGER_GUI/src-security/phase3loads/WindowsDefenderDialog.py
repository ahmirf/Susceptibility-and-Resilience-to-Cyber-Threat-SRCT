...
#         stime_= strftime("%H-%M-%S-%MS", time.localtime())
        ...
        page1 = PageHome(nb, loadNumber, mathsQNumber)
        page2 = PageUpdate(nb, loadNumber, mathsQNumber)
        ...
        page3.Bind(wx.EVT_LEFT_DOWN, self.OnHistoryTabClick, page3)
    ...
    def OnHistoryTabClick(self,event):
        print "history tab clicked"
            #WindowsDefenderDialog.allResponses+="|"+RESPONSECODE.ANTIVIRUS_HISTORY_CLICKED
            #WindowsDefenderDialog.allResponseCode+="|"+RESPONSECODE.RESPONSE[RESPONSECODE.ANTIVIRUS_HISTORY_CLICKED]
...
#         self.FitInside()
    ...
    def Ontimer(self, event): 
        ...
        if self.count == 50:
            ...
            WindowsDefenderDialog.allResponses+="|"+RESPONSECODE.ANTIVIRUS_SCAN_COMPLETE
            WindowsDefenderDialog.allResponseCode+="|"+RESPONSECODE.RESPONSE[RESPONSECODE.ANTIVIRUS_SCAN_COMPLETE]
...
#         print "check for new virus definition"
        #WindowsDefenderDialog.allResponses+="|"+RESPONSECODE.CLOSE_ON_ANTIVIRUS_UPDATE_CLICK
        #WindowsDefenderDialog.allResponseCode+="|"+RESPONSECODE.RESPONSE[RESPONSECODE.CLOSE_ON_ANTIVIRUS_UPDATE_CLICK]
