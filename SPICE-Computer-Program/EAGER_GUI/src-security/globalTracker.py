...
class FLOWORDER(object):
    # "MP3 download popup"
    FLOWORDER = ["Email-120000", "M", "iPad-scam", "virus-alert", "M", "Email-120002-f", "M", "W2", "M", "Email-120007-f", "M", "M"]
...
#     MP3_SAVE="MP3_SAVE"
    ...
    ADOBE_UPDATE_CHECKBOX_CHECKED= "ADOBE_UPDATE_CHECKBOX_CHECKED"
    ADOBE_UPDATE_CHECKBOX_UNCHECKED = "ADOBE_UPDATE_CHECKBOX_UNCHECKED"
    ...
    CLOSE_ON_ANTIVIRUS_UPDATE_CLICK = "CLOSE_ON_ANTIVIRUS_UPDATE_CLICK"
    ANTIVIRUS_HISTORY_CLICKED = "ANTIVIRUS_HISTORY_CLICKED"
    ANTIVIRUS_SCAN_COMPLETE = "ANTIVIRUS_SCAN_COMPLETE" 
    ...
    #JAVA update
    JAVA_UPDATE_OK = "JAVA_UPDATE_OK"
    JAVA_UPDATE_CLOSE = "JAVA_UPDATE_CLOSE"
    JAVA_UPDATE_IGNORED = "JAVA_UPDATE_IGNORED"
    # reset Email and Pwd
    ...
    RESPONSE[ADOBE_UPDATE_CHECKBOX_CHECKED] = "36"
    RESPONSE[ADOBE_UPDATE_CHECKBOX_UNCHECKED] = "41"
    ...
    RESPONSE[CLOSE_ON_ANTIVIRUS_UPDATE_CLICK] = "35"
    RESPONSE[ANTIVIRUS_HISTORY_CLICKED] = "39"
    RESPONSE[ANTIVIRUS_SCAN_COMPLETE] = "40"
    
    RESPONSE[JAVA_UPDATE_OK] = "37"
    RESPONSE[JAVA_UPDATE_CLOSE] = "38"
    RESPONSE[JAVA_UPDATE_IGNORED] = "42"
...
#     DIALOG_INFO = [["Email-120009-f", "Email-120004-f"], ["Email-120005-f", "Email-120008-f"], ["Email-120007-f", "Email-120009-f"], ["Email-120001-f"],["Defender Scan", "Adobe1"], ["WindowsUpdate_new", "Java"]]
    DIALOG_INFO = [["WindowsUpdate", "Adobe1"], ["WindowsUpdate_new","Java"], ["Email-120003-f", "Email-120004-f", "Defender Scan"], ["Email-120006-f", "Email-120008-f"], ["Email-120005-f", "Email-120009-f"], ["Email-120001-f"]]
